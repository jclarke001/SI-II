...
private static final long serialVersionUID = 1L;
  ...
  private DefaultComboBoxModel RuralInfo= new DefaultComboBoxModel();
  ...
  private void jbInit(Vector<RuralHouse> v) throws Exception
  {
    ...
    this.setSize(new Dimension(513, 495));
    this.setTitle("Ofertak Sortu");
    
    for(int i=0; i<v.size(); i++){
		((DefaultComboBoxModel) RuralInfo).addElement(v.get(i).toString());
	}
    jComboBox1 = new JComboBox();
	jComboBox1.setModel(RuralInfo);
    
    jComboBox1.setBounds(new Rectangle(115, 30, 115, 20));
    jLabel1.setText("Landetxe lista:");
    jLabel1.setBounds(new Rectangle(25, 30, 95, 20));
    jLabel2.setText("Lehen eguna:");
    jLabel2.setBounds(new Rectangle(25, 75, 85, 25));
    jTextField1.setBounds(new Rectangle(25, 265, 220, 25));
    jTextField1.setEditable(false);
    jLabel3.setText("Azken eguna:");
    jLabel3.setBounds(new Rectangle(260, 75, 95, 25));
    jTextField2.setBounds(new Rectangle(260, 265, 220, 25));
    jTextField2.setEditable(false);
    jLabel4.setText("Prezioa:");
    jLabel4.setBounds(new Rectangle(260, 30, 75, 20));
    jTextField3.setBounds(new Rectangle(350, 30, 115, 20));
    jTextField3.setText("0");
    jButton1.setText("Berretsi");
    jButton1.setBounds(new Rectangle(87, 405, 130, 30));
    ...
    jButton2.setText("Atzera");
    jButton2.setBounds(new Rectangle(298, 405, 130, 30));
    ...
    jLabel5.setBounds(new Rectangle(103, 319, 305, 20));
  ...
  private void jButton1_actionPerformed(ActionEvent e)
  {
	  ...
	  try{
	  	String izena= jComboBox1.getSelectedItem().toString().split("=>")[0];
		RuralHouse ruralHouse;
		ruralHouse= app.getRuralHouse(izena);
