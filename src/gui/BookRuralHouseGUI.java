...
public static final long MILLSECS_PER_DAY= 24 * 60 * 60 * 1000;
  ...
  private DefaultComboBoxModel houses= new DefaultComboBoxModel();
...
public BookRuralHouseGUI()
 {
  ...
  private void jbInit() throws Exception
  {
    ...
    this.setSize(new Dimension(509, 504));
	...
	//String landetxeak[]= new String[100000];
	for (int i=0; i<ruralHouses.size(); i++){
		((DefaultComboBoxModel) houses).addElement(ruralHouses.get(i).nameCityToString());
		//landetxeak[i]= ruralHouses.get(i).nameCityToString();
	}
	jComboBox1= new JComboBox();
	jComboBox1.setModel(houses);
	//jComboBox1 = new JComboBox(landetxeak);
    ...
    jButton2.setBounds(new Rectangle(50, 398, 130, 30));
    ...
    jButton2.addActionListener(new ActionListener()
      {
        public void actionPerformed(ActionEvent e)
        {
        	...
        	try{
        		String[] selectedHouse= jComboBox1.getSelectedItem().toString().split(", ");
        		String houseName= selectedHouse[0];
        		RuralHouse house= app.getRuralHouse(houseName);
    ...
    jButton3.setBounds(new Rectangle(305, 398, 130, 30));
