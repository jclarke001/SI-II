...
public class RuralHouse implements Serializable {
	...
	public Vector<Iruzkina> comments;
	public Vector<Restaurant> restaurants;
	...
	public RuralHouse(String name, String address, int houseNumber, Owner owner, String description, String city) {
		this.name= name;
	...
	public String nameCityToString(){
	...
	public Vector<Iruzkina> getComments() {
		return comments;
	}

	public void setComments(Vector<Iruzkina> comments) {
		this.comments = comments;
	}
	
	public void addComment(Iruzkina i){
		this.comments.add(i);
	}
